/*
 * sha256.c — straightforward SHA-256 implementation per FIPS 180-4.
 * Pure C, no external dependencies (avoids pulling in OpenSSL just for
 * this), used to checksum multi-GB GSI downloads much faster than the
 * equivalent loop in Kotlin/Java.
 */
